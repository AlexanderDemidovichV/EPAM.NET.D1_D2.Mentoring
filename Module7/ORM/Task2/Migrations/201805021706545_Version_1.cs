    ...
    public partial class Version_1 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        RecKey = c.Byte(nullable: false, identity: true),
                        PolID = c.Byte(nullable: false),
                        PolNumber = c.String(maxLength: 10, unicode: false),
                        PolType = c.String(maxLength: 15, unicode: false),
                        EffectiveDate = c.DateTime(name: "Effective Date", storeType: "date"),
                        DocID = c.Short(),
                        DocName = c.String(maxLength: 10, unicode: false),
                        Submitted = c.Byte(),
                        Outstanding = c.Byte(),
                    })
                .PrimaryKey(t => new { t.RecKey, t.PolID });
